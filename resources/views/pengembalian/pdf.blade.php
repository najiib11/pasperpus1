...
<body>
    <div class="header">
        <h2 style="margin:0;">Laporan Pengembalian Buku</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $p->tanggal_kembali ? $p->tanggal_kembali->format('d/m/Y') : '-' }}</td>
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <td class="text-center">{{ $peminjamans->sum('jumlah') }}</td>
                <td colspan="2"></td>
                <td class="text-right">Rp{{ number_format($peminjamans->sum('denda'), 0, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
</body>
