    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                <form action="{{ route('pengembalian.laporan') }}" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="md:col-span-4 flex flex-col gap-2">
                        <div class="flex gap-1">
                            ...
                            <a href="{{ route('pengembalian.laporan') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-3 py-2 rounded text-xs w-full text-center flex items-center justify-center">
                                Reset
                            </a>
                        </div>

                        <div class="flex gap-1">
                            <a href="{{ route('pengembalian.download', array_merge(request()->all(), ['jenis' => 'pdf'])) }}" target="_blank"
                               class="bg-red-600 hover:bg-red-700 text-white px-2 py-1 rounded text-xs w-full text-center">
                                PDF
                            </a>
                            <a href="{{ route('pengembalian.download', array_merge(request()->all(), ['jenis' => 'excel'])) }}"
                    ...
                    <table class="table-auto w-full border-collapse border border-gray-200 text-sm">
                        <thead class="bg-gray-100 text-gray-700 uppercase">
                            <tr>
                                ...
                                <th class="border px-4 py-2 text-center">Tgl Pinjam</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border px-4 py-2 text-right font-mono text-red-600">
