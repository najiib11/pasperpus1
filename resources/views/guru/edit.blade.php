<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-xl text-white dark:text-gray-300 font-semibold">Edit Guru</h1>
        </div>
    </x-slot>
                ...
                <form action="{{ route('guru.update', $guru->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="2"
                                  class="w-full border rounded px-3 py-2 @error('alamat') border-red-500 @enderror">{{ old('alamat', $guru->alamat) }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex items-center gap-4">
                            @if($guru->foto)
                                <img id="current-photo" src="{{ asset('storage/'.$guru->foto) }}" alt="Foto Lama"
                                     class="w-32 h-32 object-cover rounded border shadow">
                            @endif
                            <img id="preview" src="#" alt="Preview Foto Baru" class="hidden w-32 h-32 object-cover rounded border shadow">
                        </div>
                    </div>
