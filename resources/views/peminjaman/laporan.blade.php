    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                <form action="{{ route('peminjaman.laporan') }}" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">

                    <div class="md:col-span-3">
                        <label class="block text-sm font-medium text-gray-700">Tgl Awal</label>
                    ...
                    <div class="md:col-span-3 flex flex-col gap-2">
                        <div class="flex gap-1">
                            ...
                            <a href="{{ route('peminjaman.laporan') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-3 py-2 rounded text-xs w-full text-center flex items-center justify-center">
                                Reset
                            </a>
                        </div>

                        <div class="flex gap-1">
                            <a href="{{ route('peminjaman.download', array_merge(request()->all(), ['jenis' => 'pdf'])) }}" target="_blank"
                               class="bg-red-600 text-white px-2 py-1 rounded text-xs w-full text-center">PDF</a>
                            <a href="{{ route('peminjaman.download', array_merge(request()->all(), ['jenis' => 'excel'])) }}"
                               class="bg-green-600 text-white px-2 py-1 rounded text-xs w-full text-center">Excel</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table-auto w-full border-collapse border border-gray-200 text-sm">
                        <thead class="bg-gray-100 text-gray-700 uppercase">
                            <tr>
                                ...
                                <th class="border px-4 py-2 text-right">Denda</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border px-4 py-2 text-center font-bold">{{ $p->jumlah }}</td>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    @php
                                        $colors = [
                                            ...
                                            'reservasi' => 'bg-blue-100 text-blue-800'
                                        ];
