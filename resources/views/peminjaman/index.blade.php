    ...
    <div class="py-12">
        <div class="p-6 text-gray-900">
            <div class="flex flex-wrap justify-center gap-6 mb-8">
                <!-- Card Peminjaman -->
                {{-- <div
                    class="cursor-pointer flex-1 min-w-[250px] max-w-[400px] h-32 text-blue-500 bg-white hover:bg-blue-200 py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 ease-in-out flex flex-col justify-center items-center"
                ...
                <!-- Card Dikembalikan -->
                {{-- <div
                    class="cursor-pointer flex-1 min-w-[250px] max-w-[400px] h-32 text-amber-500 bg-white hover:bg-amber-200 py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 ease-in-out flex flex-col justify-center items-center"
        ...
        <!-- Tabel: Dipinjam -->
        <div id="dipinjam" class="overflow-x-auto shadow-md rounded-lg mb-6 w-full max-w-7xl mx-auto">
        ...
        <!-- Tabel: Reservasi -->
        <div id="reservasi" class="overflow-x-auto bg-white shadow-md rounded-lg mb-6 w-full max-w-7xl mx-auto">
            <table class="table-auto w-full border-collapse border border-gray-300">
                        ...
                        <tr class="bg-green-100">
                            <td colspan="6" class="px-4 py-2 font-semibold border text-gray-800">
                                ...
                                <span class="ml-4 text-sm text-gray-600">
                                    Total Antrian: {{ $reservasis->count() }}
                                </span>
                            </td>
                        </tr>
        ...
        <div id="dikembalikan"
            class="hidden overflow-x-auto bg-white shadow-md rounded-lg mb-6 w-full max-w-7xl mx-auto">
            <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-xl w-full">
                ...
                <div class="flex justify-between items-center gap-4 mt-4">
                    ...
                    <button id="btnCloseModal"
                        class="bg-gray-400 text-white px-6 py-2 rounded-md hover:bg-gray-500 transition-all duration-200">
                        Tutup
                    </button>
