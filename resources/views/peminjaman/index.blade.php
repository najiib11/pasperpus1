<x-app-layout>
    ...
    // Fetch data from the backend or pass the data directly
    ...
    // Format tanggal tenggat ke format YYYY-MM-DD (atau sesuai kebutuhan)
    ...
    // Show correct action button based on status
    if (selectedPeminjaman.status === 'dipinjam') {
        ...
        btnAction.disabled = false;
        btnAction.onclick = function () {
            // Arahkan ke halaman edit untuk peminjaman
